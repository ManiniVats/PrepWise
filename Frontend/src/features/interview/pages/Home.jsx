...
const Home = () => {
    ...
    if (selfDescription.trim() && selfDescription.trim().length < 20) {
        alert("Please provide a more detailed Self Description.")
        return
    }
    ...
    if (resumeFile) {
        ...
        if (resumeFile.size > 3 * 1024 * 1024) {
            alert("Resume must be smaller than 3 MB.")
            return
        }
    ...
    <div className="loading-overlay">
        <div className="loading-card">
            ...
            <h2>Generating Your Report & Prep Strategy</h2>
            ...
            <header className='page-header'>
                <h1>Prepare for Your Next <span className='highlight'>Interview</span></h1>
                ...
                {(selectedResume.size / (1024 * 1024)).toFixed(2)} MB
                        ...
                        <div className='self-description'>
                            ...
                            <textarea
                                ...
                                placeholder="Briefly describe your experience, key skills, projects and experience if you don't have a resume handy..."
                            />
                        </div>
                        <div className="char-counter">
...
<div className='interview-card__footer'>
    ...
    {reports.length === 0 ? (
        ...
        <div className="empty-state">
            <p>No analyses yet.</p>
            <span>Generate your first interview report to get started.</span>
        </div>
